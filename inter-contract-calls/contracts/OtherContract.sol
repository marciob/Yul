...
contract OtherContract {
    ...
    // "9a884bde": "get21()", -> it's the function signature that will be used to call this contract function
...
// this contract will be used to call other contracts using Yul
// in Yul there are 3 types of calls:
// staticcall() -> used when there is no state change, like to call view functions
// call() -> used when there is state change potential
// delegatecall()
contract ExternalCalls {
        ...
        returns (uint256)
    {
        assembly {
            ...
            // 000000000000000000000000000000000000000000000000000000009a884bde     -> it's poiting to the ABI call, which has only 4 bits, then it points only for that location
            //                                                         |       |
            //                                                         28      32
